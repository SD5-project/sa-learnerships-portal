...
if (!SignupBuilder.requireRole('applicant')) throw new Error('role check failed');
...
googleBtn.addEventListener('click', async () => {
    ...
    try {
        ...
        // Check if this email is already registered (role claim = definitely registered)
        ...
        window.location.href = 'applicant-signup-password.html';
